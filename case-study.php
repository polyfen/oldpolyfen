...
<html lang="en">
  ...
  <head>
    ...
    <meta name="keywords" content="Case Study, Process, Brand Identity Design, Branding, Brand, Graphic, Design, Logo, Creative, Strategy, Agency" />
    ...
    <meta name="twitter:description" content="Take a look behind the scenes to see how we designed our own Brand Identity under the core concept “the midpoint between business & creativity”." />
            ...
            <div class="row">
              <div class="col">
                ...
                <div id="web-development-slider" class="carousel slide card-shadow d-flex d-lg-none d-xl-none">
                  <div class="carousel-inner" role="listbox">
                    <div class="item active">
                      <img src="imgs/case-studies/developing-our-own-brand/web-development/web-cover.jpg" alt="Polyfen Web Hero Cover">
                    </div>
                    <div class="item">
                ...
                <video width="100%" height="auto" class="card-shadow d-none d-lg-block d-xl-block" style="margin-top:40px;border-radius:4px;" autoplay loop muted>
