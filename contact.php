  ...
  <body id="contact" class="dark-mode">
    ...
    <section id="contact-intro" class="container">
      ...
      <form id="contact-form" method="POST">
        ...
        <br>
        <div class="opal opal-rainbow-soft"><div class="opal-solid"><div class="opal-mask"><button id="nostyle" type="submit">Send Message</button></div></div></div>
      </form>
    </section>
    <hr>
    <section id="call">
      ...
      <div class="calendly-inline-widget" data-url="https://calendly.com/borishr/discovery?hide_event_type_details=1&hide_gdpr_banner=1&background_color=070924&text_color=ffffff&primary_color=7537f8" style="min-width:320px;height:700px;"></div>
