...
<head>
    ...
    <meta name="keywords"
        content="Creative agency, Software development, Market research, Brand strategy, Logo design, UX/UI design, Web development, Social media marketing, Email marketing, Lead generation, Sales funnels, Staff augmentation, Executive consulting" />
    <meta name="description" property="og:description"
        content="Branding, marketing, design, and software development services with flexible contract-options." />
...
<body id="pricing" class="dark-mode">
        ...
        <section id="how-we-do-it" class="container-1080 hidden">
            <section class="column">
                <div class="services-card">
                    ...
                    <h4 class="heading-3">$3,900 USD</h4>
            ...
            <section class="column">
                <div class="services-card">
                    ...
                    <h4 class="heading-3">$7,800 USD</h4>
