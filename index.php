  ...
  <body id="home" class="dark-mode">
    ...
    <div class="main-wrapper">
      ...
      <section class="container-1080 grid-box">
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/podcasttoapp-app.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/metas-investments-business-cards.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/hemingway-distillery-whiskey-bottle.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/prepkanga-stationary.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/the-barn-packaging2.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/soma-iphone-app.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/health-and-travel-stationary.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/domingo.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/altirand-ios-app-icon.webp"></div>  
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/magusvalge-menu.webp"></div>
        <div class="grid-item hidden"><img alt="" src="imgs/activity-cads/mare-totebag.webp"></div>
