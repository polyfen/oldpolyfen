        ...
        <section class="align-center" id="cover">
            <div class="hiddenHeader">
                ...
                <div class="container-1080">
                    <p>Fully-remote creative & development agency helping businesses power their solutions, 
                        brands and apps since 2018.</p>
                    <small class="caption">Start Today</small>
                    <div style="clear:both;"></div>

                    <a class="cta-button" href="discovery-call">
                        <div class="opal opal-rainbow-soft" style="border: 2px solid #7537f8;">
                            <div class="opal-solid">
                                <div class="opal-mask"
                                    style="background:none;font-family: 'BiotifBold', sans-serif !important;">Let's
                                    Talk!</div>
                            </div>
                        </div>
                    </a>
